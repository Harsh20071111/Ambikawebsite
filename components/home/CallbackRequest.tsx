                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <p className="text-gray-600 mt-3 text-lg">
                                    Fill out the form and our sales team will contact you within 24 hours with the best offer.
                                </p>
                            </div>
                            ...
                            <div className="space-y-5">
                                {[
                                    ...
                                    },
                                    {
                                        icon: MapPin,
                                        title: "Factory Visit",
                                        text: "Industrial Area Phase II, Ludhiana",
                                        sub: "Punjab 141003",
                                    },
                                    {
                                        icon: Clock,
                                    ...
                                    <div key={i} className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <p className="font-bold text-[#1c180d] text-sm">{item.title}</p>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-5">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                        <div className="space-y-2">
                                            <Label htmlFor="name" className="text-[#1c180d] font-semibold text-sm">
                                                Full Name *
                                            </Label>
                                            <Input
                                                id="name"
                                        ...
                                        <div className="space-y-2">
                                            <Label htmlFor="phone" className="text-[#1c180d] font-semibold text-sm">
                                                Phone Number *
                                            </Label>
                                            <Input
                                                id="phone"
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="email" className="text-[#1c180d] font-semibold text-sm">
                                            Email Address
                                        </Label>
                                        <Input
                                            id="email"
                                    ...
                                    <div className="space-y-2">
                                        <Label htmlFor="message" className="text-[#1c180d] font-semibold text-sm">
                                            Message *
                                        </Label>
                                        <Textarea
                                            id="message"
