...
const features = [
    {
        ...
        description: "Forged blades and chassis designed for maximum durability in hard, dry soil conditions.",
    },
    {
        icon: Award,
        title: "2-Year Warranty",
        description: "Comprehensive coverage on all moving parts. We stand by our manufacturing quality.",
    },
    {
        icon: Tag,
        title: "Factory-Direct Pricing",
        description: "No middlemen commissions. Get affordable rates straight from the manufacturer.",
    },
    {
        icon: Truck,
        title: "Pan-India Delivery",
        description: "Extensive logistics and service network covering 20+ states across India.",
    },
];
            ...
            <div className="max-w-7xl mx-auto px-4 lg:px-10 relative z-10">
                <AnimatedSection className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <p className="text-gray-600 mt-4 text-lg">
                        Experience the difference of engineering designed specifically for local farming conditions and crop varieties.
                    </p>
                </AnimatedSection>
                ...
                <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {features.map((feature, index) => (
                        ...
                        >
                            ...
                            <h3 className="text-[#1c180d] text-xl font-bold mb-2">{feature.title}</h3>
