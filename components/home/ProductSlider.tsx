...
const fallbackProducts = [
    {
        ...
        images: ["https://images.unsplash.com/photo-1500937386664-56d1dfef3854?q=80&w=2069&auto=format&fit=crop"],
        badge: "New Arrival",
    ...
    const sliderProducts = useMemo(() => {
        ...
        return products.slice(0, 5).map((p) => {
            ...
            return {
                ...
                image:
                    (p.images && p.images.length > 0) ? p.images[0] : (p.imageUrl || "https://images.unsplash.com/photo-1625246333195-bf7913e612fc?q=80&w=2070&auto=format&fit=crop"),
                images: p.images && p.images.length > 0 ? p.images : (p.imageUrl ? [p.imageUrl] : ["https://images.unsplash.com/photo-1625246333195-bf7913e612fc?q=80&w=2070&auto=format&fit=crop"]),
