      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-10 pt-16 pb-8">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400 text-sm">
                  Ambika Engineering, Opp GEB, Modasa Road,
                  <br />
                  Talod, Sabarkantha, Gujarat 383215
                </span>
              </li>
              <li>
                <a
                ...
                >
                  ...
                  <span className="text-sm">+91 95742 45964</span>
                </a>
              </li>
              <li>
                <a
                ...
                >
                  ...
                  <span className="text-sm">harshpanchal200011@gmail.com</span>
                </a>
              </li>
            </ul>
            {/* WhatsApp CTA */}
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} Ambika Engineering. All rights
            reserved.
          </p>
