      ...
      {enquiries.length === 0 ? (
        <div className="p-12 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            When customers submit the contact form, their enquiries will appear
            here.
          </p>
        </div>
      ) : (
        <div className="divide-y divide-border">
          {enquiries.map((enquiry) => (
            ...
            >
              <button
                type="button"
                className="w-full flex items-center justify-between p-5 text-left cursor-pointer hover:bg-muted/10 transition-colors border-none bg-transparent"
                onClick={() =>
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <select
                    ...
                    className={`text-xs font-medium px-3 py-1.5 rounded-full border-0 cursor-pointer focus:ring-2 focus:ring-primary/30 ${
                      enquiry.status === "New"
