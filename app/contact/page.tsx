...
const contactInfo = [
    ...
    },
    {
        icon: Mail,
        title: "Email",
        detail: "info@ambikaengineering.com",
        sub: "sales@ambikaengineering.com",
        href: "mailto:info@ambikaengineering.com",
    },
    {
        icon: MapPin,
        title: "Factory Address",
        detail: "Industrial Area, Phase II",
        sub: "Ludhiana, Punjab 141003",
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10">
                    ...
                    >
                        ...
                        <p className="text-white/70 text-lg">
                            Have a question, need a quote, or want to become a dealer? We&apos;re
                            here to help.
                        </p>
                    </motion.div>
                </div>
